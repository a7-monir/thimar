...
class Toast {
  ...
  static void show(
    ...
    ToastView.dismiss();
    ToastView.createView(msg, context, duration, gravity, backgroundColor, textColor, backgroundRadius, Border.all(color: Colors.transparent));
  }
}
          ...
          widget: Container(
            ...
            child: Container(
                ...
                child: Container(
                  ...
                  child: Text(msg, textAlign: TextAlign.center, softWrap: true, style: TextStyle(fontSize: 15.sp, color: textColor)),
                )),
          ),
          gravity: gravity),
    );
